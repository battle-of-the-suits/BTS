...
function () {
  ...
  _createClass(Loading, [{
    key: "loadingSectionAnimations",
    value: function loadingSectionAnimations() {
      var elLoadingHeading = document.querySelector("#js-loading-heading"),
          ...
          loadingTl = new _gsap.TimelineLite();
      loadingTl.to(elLoadingHeading, 1.2, {
        delay: 0.2,
        opacity: 1,
        ease: _gsap.Power4.easeIn
      }).addLabel("text-gone", '+=1.3').to(elAnimateUp, 0.55, {
        opacity: 0,
        y: -120,
        skewY: 60,
        ease: _gsap.Power4.easeIn
      }, "text-gone").to(elAnimateDown, 0.55, {
        opacity: 0,
        y: 120,
        skewY: 60,
        ease: _gsap.Power4.easeIn
      }, "text-gone").set(elLoadingSection, {
        autoAlpha: 0
      });
      return loadingTl;
    }
  }, {
    key: "landingSectionAnimations",
    value: function landingSectionAnimations() {
      var elNavigation = document.querySelector("#js-navigation"),
          landingTl = new _gsap.TimelineLite();
      landingTl.to(elNavigation, 0.7, {
        opacity: 1,
        autoAlpha: 1,
        ease: _gsap.Power4.easeIn
      });
    ...
    key: "animationEffects",
    value: function animationEffects() {
      var masterTimeline = new _gsap.TimelineMax();
      masterTimeline.add(this.loadingSectionAnimations).add(this.landingSectionAnimations, '+=2.9');
    }
  }]);
...
},{"gsap":"../node_modules/gsap/index.js"}],"scripts/app.js":[function(require,module,exports) {
"use strict";

require("../styles/index.scss");

var _Loading = _interopRequireDefault(require("./modules/Loading"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.onload = function () {
  var loading = new _Loading.default();
  loading.animationEffects();
}; // new MouseMoveEffect();
},{"../styles/index.scss":"styles/index.scss","./modules/Loading":"scripts/modules/Loading.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
