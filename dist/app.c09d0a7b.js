...
function () {
  function Loading() {
    ...
    this.smokeVideo = document.querySelector("#js-loading-video"); // this.smokeVideo.addEventListener("ended", function(){
    //     alert('hi');
    // });
  ...
  _createClass(Loading, [{
    key: "textAnimation",
    value: function textAnimation(video) {
      var _this = this;

      var textContent = document.querySelector("#js-loading-text-content");

      _gsap.default.to(textContent, 0.7, {
        opacity: 0,
        delay: 2.5,
    ...
    value: function AnimationEffects(video) {
    ...
    key: "removeLoadingSection",
    value: function removeLoadingSection() {
      _gsap.default.set(document.querySelector("#js-loading-video"), {
        display: "none"
      });
    }
  }]);
